  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Featured */}
        <Link href={`/signal/${featured.slug}`} className="block bg-[#111520] border border-[rgba(240,237,232,0.08)] rounded-lg p-8 mb-12 card-hover">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {rest.map((a) => (
            <Link key={a.slug} href={`/signal/${a.slug}`} className="block bg-[#111520] border border-[rgba(240,237,232,0.08)] rounded-lg p-6 card-hover">
