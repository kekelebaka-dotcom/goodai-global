    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-mono text-[11px] tracking-[0.12em] uppercase t-gold">Signal Desk</span>
        </div>
        <h1 className="font-serif text-3xl sm:text-4xl font-bold mb-2">Signal Briefings</h1>
        <p className="t-text2 text-sm mb-12 max-w-xl">Strategic editorial intelligence on how AI reshapes power, infrastructure, and institutions across Africa.</p>

        {/* Featured */}
        <Link href={`/signal/${featured.slug}`} className="block t-card border t-border rounded-lg overflow-hidden mb-12 card-hover">
          ...
          <div className="p-8">
            ...
            <p className="t-text2 text-base leading-relaxed mb-4 max-w-2xl">{featured.excerpt}</p>
            <div className="flex gap-4 text-xs font-mono uppercase tracking-wider t-muted">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {rest.map((a) => (
            <Link key={a.slug} href={`/signal/${a.slug}`} className="block t-card border t-border rounded-lg overflow-hidden card-hover">
              ...
              <div className="p-6">
                ...
                <p className="text-sm t-text2 leading-relaxed mb-3 line-clamp-2">{a.excerpt}</p>
                <div className="flex gap-3 text-[10px] font-mono uppercase tracking-wider t-muted">
                  <span>{a.date}</span>
