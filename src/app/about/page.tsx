    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-[#A8A49E] leading-relaxed mb-4">
          ...
          <p className="text-[#A8A49E] leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div className="border-l-2 border-[#F4B63D] pl-4">
              ...
              <p className="text-sm text-[#A8A49E]">Strategic briefings on AI and state power, policy and governance, compute and infrastructure, data sovereignty, markets and applications, and Ubuntu philosophy.</p>
            </div>
            <div className="border-l-2 border-[#3B82F6] pl-4">
              <h3 className="font-semibold mb-1">Media Intelligence — Monitoring Pipeline</h3>
              <p className="text-sm text-[#A8A49E]">Real-time audio and video monitoring with transcript-backed evidence. Automated entity detection, mention tracking, and evidence-based daily intelligence briefs.</p>
            </div>
            <div className="border-l-2 border-[#22C55E] pl-4">
              <h3 className="font-semibold mb-1">Ubuntu Constitutional — Observatory</h3>
              <p className="text-sm text-[#A8A49E]">South Africa&apos;s first citizen-driven AI constitutional observatory. Eight signal desks monitoring how AI affects equality, dignity, education, employment, and governance across 57 towns.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <blockquote className="border-l-2 border-[#F4B63D] pl-6 py-2 mb-4">
            <p className="font-serif text-xl italic text-[#F0EDE8] leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <div key={a.title} className="bg-[#111520] border border-[rgba(240,237,232,0.08)] rounded-md p-4">
                <div className="text-sm font-semibold mb-1">{a.title}</div>
                <div className="text-xs text-[#6B6862]">{a.desc}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-[#111520] border border-[rgba(240,237,232,0.08)] rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-1">Keke Lebaka</h3>
            <p className="text-sm text-[#F4B63D] mb-3">Founder &amp; Editor-in-Chief</p>
            <div className="space-y-2 text-sm text-[#A8A49E]">
              <p>Former Chief Digital Marketing Officer — Sub-Saharan Africa, <strong className="text-[#F0EDE8]">L&apos;Or&eacute;al</strong></p>
              <p>Former Group Digital Marketing Director — Africa, <strong className="text-[#F0EDE8]">Promasidor</strong> (20+ African markets)</p>
              <p>Founder, <strong className="text-[#F0EDE8]">ChiefOps.ai</strong> — AI strategy consulting</p>
              <p>Founder, <strong className="text-[#F0EDE8]">Abantu Bo Ubuntu</strong> — integrating AI for Good in governance</p>
              <p className="text-[#6B6862]">Based in Johannesburg, South Africa</p>
            </div>
          </div>
        </section>
